...
cmd_bash("s1","echo '<h2>Servido por el Server1<h2>' >> /quiz_2020/views/index.ejs");
cmd_bash("s2","echo '<h2>Servido por el Server2<h2>' >> /quiz_2020/views/index.ejs");
cmd_bash("s3","echo '<h2>Servido por el Server3<h2>' >> /quiz_2020/views/index.ejs");
cmd_bash("s4","echo '<h2>Servido por el Server4<h2>' >> /quiz_2020/views/index.ejs");
